...
\usepackage{xcolor}
\usepackage{fvextra} % better line breaking

% Global minted style

\usepackage{fvextra} % improves breaklines a lot
\setminted{
...
% Optional: a softer background box
...
\input{Appendices/fitapi}

\input{Appendices/appendix-multiple-scattering}

\input{Appendices/gradient-descent}

\input{Appendices/endf-covariances}
