...
In the $^{181}$Ta study presented here, agreement is strongest for the thinner cases (2--4~mm), while larger differences appear in the thickest cases (8--12~mm) where $C_T$ becomes large. As a practical guideline, designs that keep $C_T \leq 1.5$ avoid the edge of applicability observed in this benchmark.
