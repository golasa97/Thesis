...
\section{Converting from SAMMY Parameters to SESH Parameters}
    ...
    \subsection{Improving Level Density J Dependency}
        ...
        The updated methodology uses the same input S-wave level spacing, but instead uses Bethe formula to describe the conversion from $D_0$ to $D_J$
        \begin{equation}
    ...
    \subsection{Calculating Potential Scattering}
        ...
        The final component required for the cross-section simulation is the potential scattering. As shown in \autoref{eq:slbw}, the first part of that equation exists outside the resonance sum. This is the potential scattering term\cite{t2}, and can be written as
        \begin{equation}
