...
\section{Converting from SAMMY Parameters to SESH Parameters}
    ...
    \subsection{Calculating Available Channels}
        ...
        \begin{align}
            ...
            \mathbf{J}_{+} &= \left\{ \left|s_{+} - \ellight|, \left|s_{+} - \ellight| + 1, \cdots, s_{+} + \ell \right\}
        \end{align}
        ...
        \begin{equation}
            ...
            \mathbf{J}_{-}: & \{ & \left|s_{-} - \ellight|, & \left|s_{-} - \ellight| + 1, & \dots, & s_{-} + \ell ~ & & \} \\
            \mathbf{J}_{+}: & \{ & & \left|s_{+} - \ellight|, & \dots, & s_{+} + \ell-1, & s_{+} + \ell & \} \\\[1em] \hline \\\[-0.5em]
            \mathbf{J}_{tot}: & \{ & \left|s_{-} - \ellight|, & \left|s_{+} - \ellight|, & \dots, & s_{-} + \ell, & s_{+} + \ell & \} \\
