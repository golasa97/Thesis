...
The resultant simulated values are in strong agreement with the measurement, and nearly identical values to MCNP. This is an unsurprising result, since this measurement was used in the ENDF-8.1 \textsuperscript{181}Ta evaluation\cite{Brown2024}. The $6$~mm case shows that both MCNP and SAMMY slightly underpredict the measured yield; this is consistent with the Doppler-broadening defect previously identified in the SESH implementation (and corrected in the present work). The same issue also affects the $2$~mm case, but the impact is not visually resolvable at that thickness within the experimental uncertainties.


The comparison in \autoref{fig:mcdermott-yield-compare} is therefore expected to be highly favorable. In the recent ENDF/B-VIII.1 evaluation, the McDermott \emph{et al.} dataset was used (in part) to constrain and fit the URR parameters for \textsuperscript{181}Ta. Two immediate consequences follow. First, when SAMMY is supplied the evaluated URR parameters, it should reproduce the measured capture yield closely, since the measurements helped inform the parameters themselves. Second, because MCNP and SAMMY are both drawing from the same evaluated physics input, their predicted yields should be nearly identical, with only small residual differences arising from numerical and algorithmic implementation details rather than underlying nuclear data.
...
\begin{figure}[h!]
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Capture Yield/Figures/cc_1x2_t1_r80.png}
        \caption{
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Capture Yield/Figures/cc_1x2_t8_r20.png}
        \caption{
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.95\textwidth]{Capture Yield/Figures/rms_vs_radius_eta0.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.95\textwidth]{Capture Yield/Figures/rms_vs_thickness_eta0.png}
...
\begin{figure}[h!]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Capture Yield/Figures/rms_vs_eta_t2_r80.png}
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Capture Yield/Figures/rms_vs_eta_t6_r80.png}
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Capture Yield/Figures/rms_vs_eta_t8_r80.png}
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Capture Yield/Figures/rms_vs_eta_t8_r20.png}
